    ...
    <nav class="sp-fondo-negro px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        ...
        <div class="flex items-center gap-8">
            ...
            <div class="hidden sm:flex items-center gap-6">
                ...
                <a href="<?php echo e(route('listas-reproduccion')); ?>"
                   class="text-sm font-semibold transition <?php echo e(request()->routeIs('listas-reproduccion') ? 'sp-enlace-activo' : 'sp-enlace-nav'); ?>">
                    Mis listas
                </a>
            </div>
        </div>
...
<?php /**PATH C:\wamp64\www\DAW2\proyectos\MySpotify\MySpoty\resources\views/layouts/cliente.blade.php ENDPATH**/ ?>