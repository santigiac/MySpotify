...
<body style="background-color: #121212;" class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-sm rounded-xl p-8" style="background-color: #282828;">
        ...
        <form id="form-login" method="POST" action="<?php echo e(route('login.entrar')); ?>"
        ...
        <p class="text-center text-sm mt-6" style="color: #b3b3b3;">
            ¿No tienes cuenta?
            <a href="<?php echo e(route('registro')); ?>" class="font-semibold underline" style="color: #1DB954;">
                Regístrate gratis
            </a>
        </p>
...
<?php /**PATH C:\wamp64\www\DAW2\proyectos\MySpotify\MySpoty\resources\views/auth/login.blade.php ENDPATH**/ ?>