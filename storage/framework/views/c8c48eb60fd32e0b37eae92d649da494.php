<?php $__env->startSection('titulo', 'Nueva canción — Admin MiSpoty'); ?>
...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <form method="POST"
              action="<?php echo e(route('admin.canciones.guardar')); ?>"
...
unset($__errorArgs, $__bag); ?>">
            ...
            <div>
                ...
                <input type="text" name="artist" value="<?php echo e(old('artist')); ?>"
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $generos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genero): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($genero->id); ?>" <?php echo e(old('genre_id') == $genero->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\DAW2\proyectos\MySpotify\resources\views/admin/canciones/crear.blade.php ENDPATH**/ ?>