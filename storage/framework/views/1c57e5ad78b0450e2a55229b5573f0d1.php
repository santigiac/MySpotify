...
<head>
    ...
    <title><?php echo $__env->yieldContent('titulo', 'MiSpoty — Admin'); ?></title>
...
<body class="sp-fondo min-h-screen flex flex-col">
    ...
    <nav class="sp-fondo-negro sp-borde-inferior-verde px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        ...
        <div class="flex items-center gap-8">
            ...
            <div class="hidden sm:flex items-center gap-6">
                <a href="<?php echo e(route('admin.canciones.index')); ?>"
                   class="text-sm font-semibold transition <?php echo e(request()->routeIs('admin.canciones.*') ? 'sp-enlace-activo' : 'sp-enlace-nav'); ?>">
                    Canciones
                </a>
                <a href="<?php echo e(route('admin.usuarios.index')); ?>"
                   class="text-sm font-semibold transition <?php echo e(request()->routeIs('admin.usuarios.*') ? 'sp-enlace-activo' : 'sp-enlace-nav'); ?>">
                    Usuarios
                </a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4">
            <span class="text-sm text-white font-semibold"><?php echo e(Auth::user()->name); ?></span>
    ...
    <script src="<?php echo e(asset('js/confirmar.js')); ?>"></script>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH C:\wamp64\www\DAW2\proyectos\MySpotify\resources\views/layouts/admin.blade.php ENDPATH**/ ?>